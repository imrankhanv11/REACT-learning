            ...
            <Container>
                <Row className=" gy-3 text-center text-md-start">
                    <Col md={4} className="mt-2">
                        <h5 className="fw-bolder mb-3 text-danger">Students Manager App</h5>
                        <p className="small">
                            A Student Manager to Track and Manage student Details
                        </p>
                    </Col>
                    ...
                    <Col md={4}>
                        ...
                        <ul className="list-unstyled small">
                            ...
                            <li><a href="/studentform" className="text-white text-decoration-none">Form</a></li>
                        </ul>
                    </Col>

                    <Col md={4}>
                        <h6 className="fw-bolder mb-3 text-danger">Contact Us</h6>
                        <p className="small mb-1">@studentManager</p>
